                ...
                <>
                  {user?.role === 'owner-event' && (
                    <>
                      ...
                      <button onClick={() => navigate('/inbox')} className="px-4 py-2.5 rounded-lg text-base font-semibold text-white hover:bg-white/20 backdrop-blur-sm transition-all duration-200 shadow-lg hover:shadow-xl">
                        Inbox
                      </button>
                    </>
                  )}
